...
Gem::Specification.new do |s|
  ...
  s.name = 'backport_dig'
  s.summary = 'backport_dig is the backport of Hash#dig and Array#dig in Ruby 2.3.0 to older Ruby versions.'
  s.description = 'backport_dig is the backport of Hash#dig and Array#dig in Ruby 2.3.0 to older Ruby versions.'
